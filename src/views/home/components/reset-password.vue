<template>
  <div class="reset-password-form">
    <div class="form-left">
      <el-form :model="formData" ref="ruleResetPasswordForm" :rules="registerRules">
        ...
        <el-form-item>
          <el-button @click="sendVerificationCode(ruleResetPasswordForm)">发送验证码</el-button>
          <!-- <el-button plain @click="resetForm(ruleResetPasswordForm)">重置</el-button> -->
        </el-form-item>
      </el-form>
      <div class="opperate-btns" style="display: flex;">
        <el-button class="btn-reset-password" @click="submitRegisterForm(ruleResetPasswordForm)" plain>重置密码</el-button>

...
let resetPasswordMiddleware =async (ctx,next) =>{
  let params = ctx.request.body;
  let requiredParamsList = []
  let res = {
    success:true
...
module.exports = {
getVerificationCodeMiddleware,registerWithMailMiddleware,handleLoginMiddleware,handleLogoutMiddleware,resetPasswordMiddleware
}
